...
export default function Footer() {
  ...
  const services = ['Web Development', 'Web Design', 'Digital Marketing', 'SEO', 'E-commerce'];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              <img src={Logo.src} alt="Logo" className="w-6 md:w-8 h-6 md:h-8" />
              <span className="text-white font-bold text-xl md:text-2xl">Web x Hunter</span>
            </div>
            <p className="text-gray-400 text-sm md:text-base mb-6 max-w-md leading-relaxed">
              We specialize in creating innovative and effective digital solutions for businesses of all sizes. From stunning websites to comprehensive digital strategies.
            </p>
          ...
          {/* Services */}
          <div>
            <h3 className="text-white font-semibold mb-4 md:mb-6 text-base md:text-lg">Services</h3>
            <ul className="space-y-4">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-500 hover:text-orange-400 text-xs md:text-sm transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-500 hover:text-orange-400 text-xs md:text-sm transition-colors duration-200">
                Terms of Service
